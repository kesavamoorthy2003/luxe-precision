...
//           {editing && (
//             <button className="absolute -bottom-1 -right-1 w-7 h-7 bg-[#2B3FE7]
...
//         ].map(field => (
//           <div key={field.key} className={field.key === 'phone' ? '' : ''}>
...
//                 ${editing
//                   ? 'border-gray-200 focus:border-[#2B3FE7]'
...
//         <button className="px-5 py-2.5 bg-[#2B3FE7] text-white rounded-full text-xs
//           font-bold tracking-widest uppercase hover:bg-blue-700 transition-all">
//           + Add New
//         </button>
//       </div>
...
//               ${addr.isDefault ? 'border-[#2B3FE7] bg-blue-50/30' : 'border-gray-100'}`}>
//             <div className="flex items-start justify-between mb-3">
//               <div className="flex items-center gap-2">
//                 <span className="text-xs font-bold bg-gray-100 text-gray-600
//                   px-3 py-1 rounded-full">
//                   {addr.label}
//                 </span>
//                 {addr.isDefault && (
//                   <span className="text-xs font-bold bg-[#2B3FE7] text-white
//                     px-3 py-1 rounded-full">
//                     Default
//                   </span>
//                 )}
...
//                 <button className="text-xs text-[#2B3FE7] hover:underline font-semibold">
//                   Edit
//                 </button>
...
//         {MOCK_CARDS.map(card => (
//           <div key={card.id}
//             className={`border-2 rounded-2xl p-5 flex items-center justify-between
//               ${card.isDefault ? 'border-[#2B3FE7] bg-blue-50/30' : 'border-gray-100'}`}>
//             <div className="flex items-center gap-4">
//               {/* Card Icon */}
//               <div className={`w-12 h-8 rounded-lg flex items-center justify-center text-white text-xs font-black
...
//               </div>
//               {card.isDefault && (
//                 <span className="text-xs font-bold bg-[#2B3FE7] text-white px-3 py-1 rounded-full">
//                   Default
//                 </span>
//               )}
//             </div>
...
//           Backend connect ஆனா real cards save ஆகும்.
//         </p>
//       </div>
//     </div>
//   )
...
//           ))}
//           <button className="px-6 py-3 bg-[#2B3FE7] text-white rounded-full text-xs
//             font-bold tracking-widest uppercase hover:bg-blue-700 transition-all w-fit">
//             Update Password
//           </button>
//         </div>
//       </div>
...
//           {[
//             { key: 'orders',       label: 'Order Updates',    sub: 'Shipping and delivery notifications' },
//             { key: 'promotions',   label: 'Promotions',       sub: 'Exclusive deals and offers' },
//             { key: 'newsletter',   label: 'Newsletter',       sub: 'Editorial and new arrivals' },
//           ].map(item => (
//             <div key={item.key}
...
//                   ${notifications[item.key] ? 'bg-[#2B3FE7]' : 'bg-gray-200'}`}
//               >
//                 <div className={`absolute top-1 w-4 h-4 bg-white rounded-full
//                   shadow transition-all ${notifications[item.key] ? 'left-7' : 'left-1'}`} />
//               </button>
//             </div>
//           ))}
//         </div>
...
//         <h3 className="text-sm font-bold text-red-500 mb-4 uppercase tracking-widest">
//           Danger Zone
//         </h3>
//         <div className="flex flex-col gap-3 sm:flex-row">
//           <button
//             onClick={() => { logout(); navigate('/') }}
//             className="px-6 py-3 border border-red-200 text-red-500 rounded-full
//               text-xs font-bold tracking-widest uppercase hover:bg-red-500
//               hover:text-white transition-all"
//           >
//             Sign Out
//           </button>
//           <button className="px-6 py-3 border border-red-200 text-red-500 rounded-full
//             text-xs font-bold tracking-widest uppercase hover:bg-red-500
//             hover:text-white transition-all">
//             Delete Account
//           </button>
...
//         <p className="text-gray-400 text-sm">Login to view your profile</p>
//         <button
